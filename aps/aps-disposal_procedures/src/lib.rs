...
#[table_model(default(aps_entities::entities::table_name_id, "disposal_procedures"))]
...
impl ::diesel_builders::GetColumn<aps_entities::entities::id> for DisposalProcedure {
    fn get_column_ref(
        &self,
