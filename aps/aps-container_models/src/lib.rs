...
#[table_model(default(aps_entities::entities::table_name_id, "container_models"))]
...
impl ::diesel_builders::GetColumn<aps_entities::entities::id> for ContainerModel {
    fn get_column_ref(
        &self,
    ) -> &<container_models::id as ::diesel_builders::ColumnTyped>::ColumnType {
        &self.id
...
impl ::diesel_builders::GetColumn<aps_ownables::ownables::id> for ContainerModel {
    fn get_column_ref(
        &self,
    ) -> &<container_models::id as ::diesel_builders::ColumnTyped>::ColumnType {
        &self.id
