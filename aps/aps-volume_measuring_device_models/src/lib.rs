...
#[table_model(default(aps_entities::entities::table_name_id, "volume_measuring_device_models"))]
...
impl ::diesel_builders::GetColumn<aps_entities::entities::id> for VolumeMeasuringDeviceModel {
    fn get_column_ref(
        &self,
    ) -> &<volume_measuring_device_models::id as ::diesel_builders::ColumnTyped>::ColumnType {
        &self.id
