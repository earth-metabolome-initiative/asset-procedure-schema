    ...
    for PackagingProcedureTemplate
{
    fn get_column_ref(
        &self,
    ) -> &<packaging_procedure_templates::id as diesel_builders::Typed>::ColumnType {
        &self.id
    }
}
