...
#[table_model(default(aps_entities::entities::table_name_id, "aliquoting_procedures"))]
...
impl ::diesel_builders::GetColumn<aps_entities::entities::id> for AliquotingProcedure {
    fn get_column_ref(
        &self,
