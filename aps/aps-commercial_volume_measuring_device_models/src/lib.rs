//! Auto-generated crate for the `commercial_volume_measuring_device_models`
//! table.
#[derive(
    Copy,
    Clone,
...
{
    fn get_column_ref (& self) -> & < commercial_volume_measuring_device_models :: id as :: diesel_builders :: ColumnTyped > :: ColumnType{
        &self.id
    }
}
