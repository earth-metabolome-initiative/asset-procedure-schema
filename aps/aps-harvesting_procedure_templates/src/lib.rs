...
:: diesel_builders :: prelude :: fk ! ((harvesting_procedure_templates :: id , harvesting_procedure_templates :: procedure_template_sample_source_model_id) -> (:: aps_reused_procedure_template_asset_models :: reused_procedure_template_asset_models :: procedure_template_id , :: aps_reused_procedure_template_asset_models :: reused_procedure_template_asset_models :: procedure_template_asset_model_id));
:: diesel_builders :: prelude :: fk ! ((harvesting_procedure_templates :: id , harvesting_procedure_templates :: procedure_template_sample_model_id) -> (:: aps_reused_procedure_template_asset_models :: reused_procedure_template_asset_models :: procedure_template_id , :: aps_reused_procedure_template_asset_models :: reused_procedure_template_asset_models :: procedure_template_asset_model_id));
impl diesel_builders::GetColumn<aps_procedure_templates::procedure_templates::id>
    for HarvestingProcedureTemplate
{
    fn get_column_ref(
        &self,
    ) -> &<harvesting_procedure_templates::id as diesel_builders::Typed>::ColumnType {
        &self.id
    }
}
