...
#[table_model(default(aps_entities::entities::table_name_id, "freezing_procedures"))]
...
impl ::diesel_builders::GetColumn<aps_entities::entities::id> for FreezingProcedure {
    fn get_column_ref(
        &self,
