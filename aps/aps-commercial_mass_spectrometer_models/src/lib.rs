//! Auto-generated crate for the `commercial_mass_spectrometer_models` table.
#[derive(
    Copy,
    Clone,
    Debug,
...
# [table_model (foreign_key ((mass_spectrometer_model_id ,) , (:: aps_mass_spectrometer_models :: mass_spectrometer_models :: id)))]
...
# [diesel (table_name = commercial_mass_spectrometer_models)]
pub struct CommercialMassSpectrometerModel {
    ...
    #[infallible]
    # [diesel (sql_type = :: rosetta_uuid :: diesel_impls :: Uuid)]
    mass_spectrometer_model_id: ::rosetta_uuid::Uuid,
}
impl ::diesel_builders::GetColumn<aps_asset_models::asset_models::id>
    for CommercialMassSpectrometerModel
{
    fn get_column_ref(
        &self,
    ) -> &<commercial_mass_spectrometer_models::id as ::diesel_builders::ColumnTyped>::ColumnType
    {
        &self.id
    }
}
...
impl ::diesel_builders::GetColumn<aps_entities::entities::id> for CommercialMassSpectrometerModel {
    fn get_column_ref(
        &self,
    ) -> &<commercial_mass_spectrometer_models::id as ::diesel_builders::ColumnTyped>::ColumnType
    {
...
impl ::diesel_builders::GetColumn<aps_ownables::ownables::id> for CommercialMassSpectrometerModel {
    fn get_column_ref(
        &self,
    ) -> &<commercial_mass_spectrometer_models::id as ::diesel_builders::ColumnTyped>::ColumnType
    {
