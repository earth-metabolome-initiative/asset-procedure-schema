...
#[table_model(default(aps_entities::entities::table_name_id, "freezer_models"))]
...
impl ::diesel_builders::GetColumn<aps_asset_models::asset_models::id> for FreezerModel {
    fn get_column_ref(
        &self,
    ) -> &<freezer_models::id as ::diesel_builders::ColumnTyped>::ColumnType {
        &self.id
    }
}
impl ::diesel_builders::GetColumn<aps_entities::entities::id> for FreezerModel {
    fn get_column_ref(
        &self,
    ) -> &<freezer_models::id as ::diesel_builders::ColumnTyped>::ColumnType {
        &self.id
...
impl ::diesel_builders::GetColumn<aps_ownables::ownables::id> for FreezerModel {
    fn get_column_ref(
        &self,
    ) -> &<freezer_models::id as ::diesel_builders::ColumnTyped>::ColumnType {
        &self.id
