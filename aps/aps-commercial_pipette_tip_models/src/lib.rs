//! Auto-generated crate for the `commercial_pipette_tip_models` table.
#[derive(
    Copy,
    Clone,
    Debug,
...
#[table_model(default(aps_entities::entities::table_name_id, "commercial_pipette_tip_models"))]
# [diesel (table_name = commercial_pipette_tip_models)]
    ...
    for CommercialPipetteTipModel
{
    fn get_column_ref(
        &self,
    ) -> &<commercial_pipette_tip_models::id as ::diesel_builders::ColumnTyped>::ColumnType {
        &self.id
    }
}
...
impl ::diesel_builders::GetColumn<aps_entities::entities::id> for CommercialPipetteTipModel {
    fn get_column_ref(
        &self,
    ) -> &<commercial_pipette_tip_models::id as ::diesel_builders::ColumnTyped>::ColumnType {
        &self.id
...
impl ::diesel_builders::GetColumn<aps_ownables::ownables::id> for CommercialPipetteTipModel {
    fn get_column_ref(
        &self,
    ) -> &<commercial_pipette_tip_models::id as ::diesel_builders::ColumnTyped>::ColumnType {
        &self.id
