...
#[table_model(default(aps_entities::entities::table_name_id, "pouring_procedure_templates"))]
    ...
    for <pouring_procedure_templates::table as ::diesel_builders::TableExt>::NewValues
{
    ...
    fn validate_column(volume: &f32) -> Result<(), Self::Error> {
        use diesel::Column;
        if volume <= &0f32 {
            return Err (:: validation_errors :: ValidationError :: strictly_greater_than_value (< crate :: pouring_procedure_templates :: table as :: diesel_builders :: TableExt > :: TABLE_NAME , crate :: pouring_procedure_templates :: volume :: NAME , 0f64)) ;
        }
        Ok(())
    }
}
impl ::diesel_builders::GetColumn<aps_entities::entities::id> for PouringProcedureTemplate {
    fn get_column_ref(
        &self,
...
impl ::diesel_builders::GetColumn<aps_ownables::ownables::id> for PouringProcedureTemplate {
    fn get_column_ref(
        &self,
    ) -> &<pouring_procedure_templates::id as ::diesel_builders::ColumnTyped>::ColumnType {
        &self.id
