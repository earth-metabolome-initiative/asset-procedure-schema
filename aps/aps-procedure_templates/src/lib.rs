...
:: diesel_builders :: prelude :: fk ! ((procedure_templates :: created_by_id) -> (:: aps_users :: users :: id));
:: diesel_builders :: prelude :: fk ! ((procedure_templates :: updated_by_id) -> (:: aps_users :: users :: id));
...
impl ::diesel_builders::ValidateColumn<procedure_templates::updated_at>
    for <procedure_templates::table as ::diesel_builders::TableExt>::NewValues
{
    type Error = ::validation_errors::ValidationError<&'static str>;
    #[inline]
