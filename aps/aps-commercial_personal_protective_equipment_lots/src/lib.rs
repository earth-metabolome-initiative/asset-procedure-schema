//! Auto-generated crate for the `commercial_personal_protective_equipment_lots`
//! table.
#[derive(
    Copy,
    Clone,
...
# [diesel (belongs_to (aps_commercial_personal_protective_equipment_models :: CommercialPersonalProtectiveEquipmentModel , foreign_key = commercial_personal_protective_equipment_model_id))]
# [diesel (belongs_to (aps_commercial_product_lots :: CommercialProductLot , foreign_key = id))]
# [diesel (belongs_to (aps_personal_protective_equipment_models :: PersonalProtectiveEquipmentModel , foreign_key = id))]
# [table_model (foreign_key ((commercial_personal_protective_equipment_model_id ,) , (:: aps_commercial_personal_protective_equipment_models :: commercial_personal_protective_equipment_models :: id)))]
...
pub struct CommercialPersonalProtectiveEquipmentLot {
    ...
    #[infallible]
    # [diesel (sql_type = :: rosetta_uuid :: diesel_impls :: Uuid)]
    commercial_personal_protective_equipment_model_id: ::rosetta_uuid::Uuid,
}
impl ::diesel_builders::GetColumn<aps_asset_models::asset_models::id>
    for CommercialPersonalProtectiveEquipmentLot
{
    fn get_column_ref (& self) -> & < commercial_personal_protective_equipment_lots :: id as :: diesel_builders :: ColumnTyped > :: ColumnType{
        &self.id
    }
}
