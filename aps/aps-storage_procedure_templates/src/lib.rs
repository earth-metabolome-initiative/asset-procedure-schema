...
#[table_model(default(aps_ownables::ownables::ownable_table_id, "storage_procedure_templates"))]
    ...
    for <storage_procedure_templates::table as ::diesel_builders::TableExt>::NewValues
{
    ...
    fn validate_column(kelvin: &f32) -> Result<(), Self::Error> {
        use diesel::Column;
        if kelvin <= &0f32 {
            return Err (:: validation_errors :: ValidationError :: strictly_greater_than_value (< crate :: storage_procedure_templates :: table as :: diesel_builders :: TableExt > :: TABLE_NAME , crate :: storage_procedure_templates :: kelvin :: NAME , 0f64)) ;
        }
        Ok(())
    }
}
    ...
    for <storage_procedure_templates::table as ::diesel_builders::TableExt>::NewValues
{
    ...
    fn validate_column(kelvin_tolerance_percentage: &f32) -> Result<(), Self::Error> {
        ...
        if kelvin_tolerance_percentage <= &0f32 {
            return Err (:: validation_errors :: ValidationError :: strictly_greater_than_value (< crate :: storage_procedure_templates :: table as :: diesel_builders :: TableExt > :: TABLE_NAME , crate :: storage_procedure_templates :: kelvin_tolerance_percentage :: NAME , 0f64)) ;
        }
        if kelvin_tolerance_percentage > &100f32 {
            return Err (:: validation_errors :: ValidationError :: smaller_than_value (< crate :: storage_procedure_templates :: table as :: diesel_builders :: TableExt > :: TABLE_NAME , crate :: storage_procedure_templates :: kelvin_tolerance_percentage :: NAME , 100f64)) ;
        }
        Ok(())
    }
}
impl ::diesel_builders::GetColumn<aps_ownables::ownables::id> for StorageProcedureTemplate {
    fn get_column_ref(
        &self,
