CREATE TABLE IF NOT EXISTS geopositioning_device_models (
	id UUID PRIMARY KEY REFERENCES physical_asset_models (id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS commercial_geopositioning_device_models (
	id UUID PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS commercial_geopositioning_device_lots (
	id UUID PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS geopositioning_devices (
