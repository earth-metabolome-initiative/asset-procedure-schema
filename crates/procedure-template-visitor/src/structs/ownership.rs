...
use geometric_traits::{
    ...
    traits::{
        BipartiteGraph, EdgesBuilder, MonopartiteGraph, MonoplexGraph, TransposedMonoplexGraph,
    },
};
...
impl Ownership {
        ...
        ProcedureTemplateAssetModel: FKProcedureTemplateAssetModelsAssetModelId<C>,
    {
        ...
        let derivatives = (ptams, GenericBiMatrix2D::new(directed)).into();
...
pub trait OwnershipLike: AsRef<Ownership> {
    ...
    ///   to retrieve.
    fn ptam_by_primary_key(&self, primary_key: Uuid) -> Option<&ProcedureTemplateAssetModel> {
        self.as_ref()
            .graph
            .right_nodes_vocabulary()
