CREATE TABLE ball_mill_procedure_templates (
	...
	bead_model_id UUID NOT NULL REFERENCES bead_models(id),
	procedure_template_bead_model_id UUID NOT NULL REFERENCES procedure_template_asset_models(id) ON DELETE CASCADE,
	...
	milled_with_model_id UUID NOT NULL REFERENCES ball_mill_machine_models(id),
	procedure_template_milled_with_model_id UUID NOT NULL REFERENCES procedure_template_asset_models(id) ON DELETE CASCADE,
	-- The container that is being milled.
	milled_container_model_id UUID NOT NULL REFERENCES volumetric_container_models(id),
	procedure_template_milled_container_model_id UUID NOT NULL REFERENCES procedure_template_asset_models(id),
...
CREATE TABLE ball_mill_procedures (
	...
	procedure_template_bead_model_id UUID NOT NULL REFERENCES procedure_template_asset_models(id),
	...
	procedure_template_milled_with_model_id UUID NOT NULL REFERENCES procedure_template_asset_models(id),
