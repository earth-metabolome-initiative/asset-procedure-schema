CREATE TABLE freeze_drying_procedure_templates (
	...
	freeze_dried_with_model_id UUID NOT NULL REFERENCES freeze_dryer_models(id),
	procedure_template_freeze_dried_with_model_id UUID NOT NULL REFERENCES procedure_template_asset_models(id) ON DELETE CASCADE,
	-- The container that is being freeze_dried.
	freeze_dried_container_model_id UUID NOT NULL REFERENCES volumetric_container_models(id),
	procedure_template_freeze_dried_container_model_id UUID NOT NULL REFERENCES procedure_template_asset_models(id),
...
INSERT INTO table_names (id) VALUES ('freeze_drying_procedure_templates') ON CONFLICT DO NOTHING;
CREATE TABLE freeze_drying_procedures (
	...
	freeze_drying_procedure_template_id UUID NOT NULL REFERENCES freeze_drying_procedure_templates(id),
	...
	procedure_template_freeze_dried_with_model_id UUID NOT NULL REFERENCES procedure_template_asset_models(id),
...
INSERT INTO table_names (id) VALUES ('freeze_drying_procedures') ON CONFLICT DO NOTHING;