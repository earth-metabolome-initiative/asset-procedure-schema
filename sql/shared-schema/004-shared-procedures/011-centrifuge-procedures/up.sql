CREATE TABLE centrifuge_procedure_templates (
	...
	centrifuged_with_model_id UUID NOT NULL REFERENCES centrifuge_models(id),
	procedure_template_centrifuged_with_model_id UUID NOT NULL REFERENCES procedure_template_asset_models(id) ON DELETE CASCADE,
	-- The container that is being centrifuged.
	centrifuged_container_model_id UUID NOT NULL REFERENCES volumetric_container_models(id),
	-- The centrifuged container model should allways be an asset model that is compatible with the procedure_id template.
	procedure_template_centrifuged_container_model_id UUID NOT NULL REFERENCES procedure_template_asset_models(id),
...
CREATE TABLE centrifuge_procedures (
	...
	centrifuge_procedure_template_id UUID NOT NULL REFERENCES centrifuge_procedure_templates(id),
	...
	procedure_template_centrifuged_with_model_id UUID NOT NULL REFERENCES procedure_template_asset_models(id),
