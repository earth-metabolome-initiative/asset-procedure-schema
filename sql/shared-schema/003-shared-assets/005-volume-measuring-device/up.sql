...
INSERT INTO asset_model_tables (id) VALUES ('volume_measuring_device_models') ON CONFLICT DO NOTHING;
...
INSERT INTO asset_tables (id) VALUES ('volume_measuring_devices') ON CONFLICT DO NOTHING;