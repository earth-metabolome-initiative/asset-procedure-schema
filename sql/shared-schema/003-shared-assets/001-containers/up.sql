...
INSERT INTO ownable_tables (id) VALUES ('container_models') ON CONFLICT DO NOTHING;
...
INSERT INTO ownable_tables (id) VALUES ('weighed_container_models') ON CONFLICT DO NOTHING;
...
INSERT INTO ownable_tables (id) VALUES ('volumetric_container_models') ON CONFLICT DO NOTHING;
...
INSERT INTO ownable_tables (id) VALUES ('containers') ON CONFLICT DO NOTHING;
...
INSERT INTO ownable_tables (id) VALUES ('volumetric_containers') ON CONFLICT DO NOTHING;
...
INSERT INTO ownable_tables (id) VALUES ('container_sealer_models') ON CONFLICT DO NOTHING;