...
INSERT INTO ownable_tables (id) VALUES ('freeze_dryer_models') ON CONFLICT DO NOTHING;
...
INSERT INTO ownable_tables (id) VALUES ('commercial_freeze_dryer_models') ON CONFLICT DO NOTHING;
...
INSERT INTO ownable_tables (id) VALUES ('commercial_freeze_dryer_lots') ON CONFLICT DO NOTHING;
...
INSERT INTO ownable_tables (id) VALUES ('freeze_dryers') ON CONFLICT DO NOTHING;