...
INSERT INTO asset_model_tables (id) VALUES ('freezer_models') ON CONFLICT DO NOTHING;
...
INSERT INTO asset_model_tables (id) VALUES ('commercial_freezer_models') ON CONFLICT DO NOTHING;
...
INSERT INTO asset_model_tables (id) VALUES ('commercial_freezer_lots') ON CONFLICT DO NOTHING;
...
INSERT INTO asset_tables (id) VALUES ('freezers') ON CONFLICT DO NOTHING;