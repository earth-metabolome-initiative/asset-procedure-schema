...
INSERT INTO asset_model_tables (id) VALUES ('centrifuge_models') ON CONFLICT DO NOTHING;
...
INSERT INTO asset_model_tables (id) VALUES ('commercial_centrifuge_models') ON CONFLICT DO NOTHING;
...
INSERT INTO asset_model_tables (id) VALUES ('commercial_centrifuge_lots') ON CONFLICT DO NOTHING;
...
INSERT INTO asset_tables (id) VALUES ('centrifuges') ON CONFLICT DO NOTHING;